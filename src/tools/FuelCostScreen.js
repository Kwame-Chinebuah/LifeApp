...
export default function FuelCostScreen({ navigation }) {
  ...
  const [unit, setUnit]           = useState('mpg'); // mpg or L100km
    ...
    <SafeAreaView style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.field}>
          ...
          <View style={styles.inputRow}>
            <TextInput style={styles.input} value={efficiency} onChangeText={setEfficiency}
              keyboardType="numeric" placeholder="0" placeholderTextColor={COLORS.textTertiary} />
        ...
        <View style={styles.field}>
          ...
          <View style={styles.inputRow}>
            ...
            <Text style={styles.inputUnit}>per litre</Text>
          </View>
        </View>
        ...
        {result && (
          <View style={styles.results}>
            ...
            <View style={[styles.resultCard, styles.resultCardMain]}>
              ...
              <Text style={[styles.resultValue, { fontSize: 36, color: COLORS.accent }]}>
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    padding: 14, fontSize: 20, color: COLORS.textPrimary, backgroundColor: COLORS.bgSecondary,
  },
  inputUnit: { fontSize: 14, color: COLORS.textSecondary, minWidth: 40 },
  results: { gap: 12 },
  resultCard: {
