              ...
              <View style={styles.ftRow}>
                ...
                <View style={styles.inputWithUnit}>
                  <TextInput style={styles.input} value={heightIn} onChangeText={setHeightIn}
                    keyboardType="decimal-pad" placeholder="10" placeholderTextColor={COLORS.textTertiary} />
          ...
          <View style={styles.field}>
            ...
            <View style={styles.inputWithUnit}>
              <TextInput style={styles.input} value={weight} onChangeText={setWeight}
                keyboardType="decimal-pad" placeholder={unit === 'metric' ? '70' : '154'}
...
const styles = StyleSheet.create({
  ...
  input: { flex: 1, borderWidth: 0.5, borderColor: COLORS.border, borderRadius: RADIUS.lg, padding: 14, fontSize: 22, color: COLORS.textPrimary, backgroundColor: COLORS.bgSecondary },
  unit: { fontSize: 16, color: COLORS.textSecondary, width: 30 },
  ftRow: { flexDirection: 'row', gap: 12 },
  result: { padding: 20, borderRadius: RADIUS.xl, borderWidth: 2, backgroundColor: COLORS.bgSecondary, alignItems: 'center', gap: 6 },
