...
export const TOOLS = {
  essentials: [
    ...
    { id: 'Notes',          icon: '📝', label: 'Notes',           desc: 'Quick sticky notes'    },
    { id: 'ShoppingList',   icon: '🛒', label: 'Shopping List',   desc: 'Your shopping list'    },
    { id: 'MealPlanner',    icon: '🍽', label: 'Meal Planner',    desc: 'Weekly meal plan'      },
  ],
  health: [
    { id: 'BMI',            icon: '⚖️', label: 'BMI Calculator',  desc: 'Body mass index'       },
    { id: 'WaterIntake',    icon: '💧', label: 'Water Tracker',   desc: 'Daily hydration'       },
    { id: 'WeightTracker',  icon: '📉', label: 'Weight Tracker',  desc: 'Track your weight'     },
  ...
  encyclopedia: [
    { id: 'Globe',          icon: '🌐', label: 'Globe & Countries',desc: 'Countries & capitals'  },
    { id: 'SolarSystem',    icon: '🪐', label: 'Solar System',    desc: 'Planets & space'       },
  ],
  fun: [
    { id: 'DiceRoller',     icon: '🎲', label: 'Dice Roller',     desc: 'Roll any dice'         },
    { id: 'CoinFlip',       icon: '🪙', label: 'Coin Flip',       desc: 'Heads or tails'        },
    { id: 'FlagQuiz',       icon: '🏳️', label: 'Flag Quiz',       desc: 'Guess the country'     },
    { id: 'WordScramble',   icon: '🔤', label: 'Word Scramble',   desc: 'Unscramble the word'   },
    { id: 'TrueOrFalse',    icon: '✅', label: 'True or False',   desc: 'Test your knowledge'   },
    { id: 'QuickMaths',     icon: '➗', label: 'Quick Maths',     desc: 'Mental maths game'     },
  ],
};
